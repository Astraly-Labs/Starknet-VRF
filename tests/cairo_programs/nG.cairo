...
func main{output_ptr: felt*, range_check_ptr, bitwise_ptr: BitwiseBuiltin*}() {
    ...
    let sG: ExtendedPoint = TwistedArithmetics._scalar_multiply_G_by_s_loop(
        index=0,
        res=ZERO,
        s=Uint256(28862941615119807384549549317196590783, 4869509200447005120074568116659563552),
    );
    ...
    // assert sG.x.low = 42114794351893256184233311756735798781;
    // assert sG.x.high = 105724198134614256290713683444580514556;
    // assert sG.y.low = 239217761667596995751113313307787875712;
    // assert sG.y.high = 69762747036280158809166715932357629792;
    return ();
}
